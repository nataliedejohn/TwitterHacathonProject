...
def index():
    if request.method == "POST":
        ...
        #     max_tokens=100
        # )
        slider_value = request.form["slider-val"]
        print(slider_value)
...
def generate_prompt(question):
    question_phrase = """You are a regular person from the 1950s. 
    Answer every question as if you had knowledge only limited to January 23rd, 1959.
    The day is January 23rd, 1959.
    You do not know about anything that happened or was invented after January 23rd, 1959.
    If something was invented after January 23rd, 1959, answer as if you do not know what they are talking about.
    Only answer questions with 1950's rhetoric.
